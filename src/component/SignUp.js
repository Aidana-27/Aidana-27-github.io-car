...
const SignUp = ({ isOpen, onClose }) => {
    return (
      <div
        className={`signup__wrapper fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-blue-500 bg-opacity-50 transform ${isOpen ? 'scale-100' : 'scale-0'
          } transition-transform duration-300 z-50`}
      >
        <div className="signup__card bg-gray-600 w-4/12 p-12">
